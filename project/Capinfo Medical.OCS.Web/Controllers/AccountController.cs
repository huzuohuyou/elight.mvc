...
namespace Elight.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Login(string userName, string password, string verifyCode="ok")
        {
            ...
            if (password.ToUpper() != userLogOnEntity.Password.ToUpper())
            {
            ...
            else
            {
                ...
                return Success( "登录成功", operatorModel);
            }
        ...
        public ActionResult ModifyPwd(string oldPassword, string newPassword, string confirmPassword)
        {
            ...
            if (oldPassword != userLoginEntity.Password)
            {
                return Warning("旧密码验证失败。");
            }
            userLoginEntity.Password = newPassword;
